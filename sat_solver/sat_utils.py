...
class Q:
    ...
    def __lt__(self, n: int) -> list:
        return list(combinations(map(neg, self.elements), n))
    def __le__(self, n: int) -> list:
        return self < n + 1
    def __gt__(self, n: int) -> list:
        return list(combinations(self.elements, len(self.elements)-n))
    def __ge__(self, n: int) -> list:
        return self > n - 1
    def __eq__(self, n: int) -> list:
